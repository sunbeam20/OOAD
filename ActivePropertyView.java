...
public class ActivePropertyView extends JFrame implements ActionListener{	// For all Properties that has Active status for renting
	...
	public ActivePropertyView(){
		super("Admin Viewing Active Properties in the System");
		...
		*/
		...
		for(int i = 0; i < LoginFrame.propertyList.size() ; i++ ){
			if(LoginFrame.propertyList.get(i).getHiddentStatus() == false && LoginFrame.propertyList.get(i).getRentStatus().equals("Active") ){ // Views Active Properties
