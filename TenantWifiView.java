...
public class TenantWifiView extends JFrame implements ActionListener{	// all propertyList by wifi
	...
	private String t;
	public TenantWifiView(String tenant){
		...
		*/
		...
		for(int i = 0; i < LoginFrame.propertyList.size() ; i++ ){
			if(LoginFrame.propertyList.get(i).getHiddentStatus() == false && (LoginFrame.propertyList.get(i).getFacilities().equals("Wifi") || LoginFrame.propertyList.get(i).getFacilities().equals("Wifi & Swimming Pool"))){
