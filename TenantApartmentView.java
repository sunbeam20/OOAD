...
public class TenantApartmentView extends JFrame implements ActionListener{	// all apartments
	...
	private String t;
	public TenantApartmentView(String tenant){
		...
		*/
		...
		for(int i = 0; i < LoginFrame.propertyList.size() ; i++ ){
			if(LoginFrame.propertyList.get(i).getHiddentStatus() == false && LoginFrame.propertyList.get(i).getPropertyType().equals("Apartment")){
