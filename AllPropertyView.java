...
import javax.swing.JScrollPane;	// use of Scroll Pane

public class AllPropertyView extends JFrame implements ActionListener{	//All property
	...
	public AllPropertyView(){
		super("Admin Viewing All Properties in the System");
		...
		*/
		...
		for(int i = 0; i < LoginFrame.propertyList.size() ; i++ ){
			if(LoginFrame.propertyList.get(i).getHiddentStatus() == false){ //This only views the property that owner is not hiding
        ...
        JScrollPane jScrollPane = new JScrollPane(p2);  //Scroll pane added
