...
public class TenantCondominiumView extends JFrame implements ActionListener{	// All condominum
	...
	private String t;
	public TenantCondominiumView(String tenant){
		...
		*/
		...
		for(int i = 0; i < LoginFrame.propertyList.size() ; i++ ){
			if(LoginFrame.propertyList.get(i).getHiddentStatus() == false && LoginFrame.propertyList.get(i).getPropertyType().equals("Condo")){
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==logOut){
			dispose();
			LoginFrame lf = new LoginFrame();dispose();
		}
