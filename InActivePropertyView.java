...
public class InActivePropertyView extends JFrame implements ActionListener{	// Properties that are rented out
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==logOut){
			...
			DeleteProperty dp = new DeleteProperty();dispose();
		}
		else if(e.getSource()==pendingRegistration){
			ApproveRegistration ar = new ApproveRegistration();dispose();
		}
