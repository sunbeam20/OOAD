...
public class TenantSwimmingPoolView extends JFrame implements ActionListener{	//all property having swimming pool
	...
	private String t;
	public TenantSwimmingPoolView(String tenant){
		super("Tenant Viewing Condominium Properties in the System");
		t=tenant;
		...
		*/
		...
		for(int i = 0; i < LoginFrame.propertyList.size() ; i++ ){
			if(LoginFrame.propertyList.get(i).getHiddentStatus() == false && (LoginFrame.propertyList.get(i).getFacilities().equals("Swimming Pool") || LoginFrame.propertyList.get(i).getFacilities().equals("Wifi & Swimming Pool"))){
